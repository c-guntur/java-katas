...
public class TestKataPackageProtectedMethodInvocation {
    ...
    public void methodHandlePackageProtectedMethod() {
         ...
         */
        MethodHandles.Lookup packageProtectedMethodHandlesLookup = null;
        ...
        try {
            ...
            MethodHandle packageProtectedMethodHandle =
                    packageProtectedMethodHandlesLookup.unreflect(null);
