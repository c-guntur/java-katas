...
public class TestSolutionPublicStaticMethodInvocation {
    ...
    public void methodHandlePublicStaticMethod() {
         ...
         */
        MethodHandles.Lookup publicStaticMethodHandlesLookup = MethodHandles.publicLookup();
        ...
        try {
            ...
            MethodHandle publicStaticMethodHandle =
                    publicStaticMethodHandlesLookup.findStatic(DemoClass.class,
                            "publicStaticMethod", methodType); // Class, Method name, Method type
