...
public class TestSolution3CompletableFutureExecutions {
    ...
    public void runAsync() {
        ...
        CompletableFuture<Void> voidCompletableFuture =
                CompletableFuture.runAsync(() -> aList.add(SEVEN));
    ...
    public void supplyAsync() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Integer> suppliedCompletableFuture =
                CompletableFuture.supplyAsync(() -> aList.get(0));
    ...
    public void supplyAsyncWithExecutor() throws ExecutionException, InterruptedException {
        ...
        //  • For the Supplier, return the first element of aList
        CompletableFuture<Integer> suppliedCompletableFuture =
                CompletableFuture.supplyAsync(() -> aList.get(0), executor);
